...
| Create instruction bundle | **Skill** | `skills/custom/<name>/` |
...
```bash
# Create a new tool
python skills/frameworks/agent-zero-dev/scripts/create_tool.py MyTool "Description"

# Create an extension
python skills/frameworks/agent-zero-dev/scripts/create_extension.py agent_init MyExt "Description"

# Create a skill
python skills/frameworks/agent-zero-dev/scripts/create_skill.py my-skill "Description"

# Create an API endpoint
python skills/frameworks/agent-zero-dev/scripts/create_api.py MyEndpoint "Description"
```
