...
The Cosmetic Committee is an Agent Zero plugin that provides a dedicated, multi-agent team for cosmetic Web-UI customization. The team is built to help any user—from beginners to experts—make aesthetic changes to the Agent Zero Web UI without affecting its core functionality.
