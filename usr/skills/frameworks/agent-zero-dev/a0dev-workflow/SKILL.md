...
python usr/skills/frameworks/agent-zero-dev/scripts/create_tool.py WeatherTool "Look up weather for a location"
```
...
| `create_skill.py` | Skill in `usr/skills/custom/` |
