...
Output:
    Creates usr/skills/custom/<skill-name>/ directory with SKILL.md
"""
...
To use scripts, run them directly with code_execution_tool:
```json
{{
  "tool_name": "code_execution_tool",
  "tool_args": {{
    "runtime": "python",
    "code": "python /a0/usr/skills/custom/{name}/scripts/helper.py arg1"
  }}
}}
```
...
def main():
    ...
    base_dir = Path("/a0/usr/skills/custom")
    if not base_dir.exists():
        base_dir = Path("usr/skills/custom")
