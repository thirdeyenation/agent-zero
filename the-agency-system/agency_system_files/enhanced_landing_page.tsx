...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <NextSeo
        title="The Agency System - Revolutionize Your Content Experience"
        description="Leverage advanced AI to transform how you consume and create online content. Personalized experiences meet streamlined workflows."
        openGraph={{
          url: 'https://the-agency-system.com',
          title: 'The Agency System - Revolutionize Your Content Experience',
          description: 'Leverage advanced AI to transform how you consume and create online content. Personalized experiences meet streamlined workflows.',
          images: [
            {
              url: 'https://the-agency-system.com/og-image.png',
              width: 1200,
              height: 630,
              alt: 'The Agency System',
            },
          ],
        }}
      />
