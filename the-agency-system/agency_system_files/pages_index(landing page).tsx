...
import { CursorArrowRaysIcon, UserGroupIcon, RocketLaunchIcon, SparklesIcon, ChatBubbleLeftRightIcon, QuestionMarkCircleIcon } from '@heroicons/react/24/outline';
            ...
            {[
              {
                ...
                testimonial: "The Agency System has transformed how I create and manage my content. The AI-powered recommendations are spot on!"
              },
              {
                name: "Jane Smith",
                role: "Podcaster",
                testimonial: "The Manager Agent has streamlined my podcast production workflow. I can now focus on creating great content."
              },
              {
                name: "Alice Johnson",
                role: "Educator",
                testimonial: "The Curator Agent has made it so easy to discover and organize educational content. It's a game-changer!"
              }
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-bold">{testimonial.name}</h