"""
Framework Registry for Agent Zero.

This module defines the available frameworks that can be used
...
FRAMEWORK_REGISTRY: dict[str, Framework] = {
    "none": Framework(
        id="none",
        name="None",
        description="No framework. Agent operates with standard skills only.",
        skill_prefix="",
        workflows=[],
    ),
    "gsd": Framework(
