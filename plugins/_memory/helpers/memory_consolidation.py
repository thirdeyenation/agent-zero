...
class MemoryConsolidator:
    ...
    async def _extract_search_keywords(
        ...
        try:
            ...
            keywords_json = dirty_json.try_parse(keywords_response.strip())  # ⚡ Bolt: Use try_parse for standard json fast path
    ...
    async def _analyze_memory_consolidation(
        ...
        try:
            ...
            # Parse LLM response
            result_json = dirty_json.try_parse(analysis_response.strip())  # ⚡ Bolt: Use try_parse for standard json fast path
