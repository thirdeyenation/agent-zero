...
def is_in_dir(path: str, dir: str):
    ...
    # Optimization: Avoid os.path.commonpath which uses internal list allocations and path splitting.
    # Instead, use faster string matching while preventing path traversal bugs.
