...
def is_in_dir(path: str, dir: str):
    ...
    # ⚡ Bolt Optimization: Use string matching instead of os.path.commonpath for ~4x speedup
    # Handles edge cases like trailing slashes and overlapping prefixes (e.g. /a/bc vs /a/b)
